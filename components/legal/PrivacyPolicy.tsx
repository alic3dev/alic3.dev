...
export function PrivacyPolicy(): React.ReactElement {
  return (
    <div>
      ...
      <p>
        At alic3dev, accessible from <Link href="/">alic3.dev</Link>, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        alic3dev and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in alic3dev. This policy is not applicable to any
      ...
      <p>
        ...
        advertisements and links that appear on alic3dev, which are sent
      ...
      <p>
        Note that alic3dev has no access to or control over these cookies that
      ...
      <p>
        alic3dev does not knowingly collect any Personal Identifiable
