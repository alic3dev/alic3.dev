  ...
  return (
    <div>
      ...
      <p>
        ...
        conditions. Do not continue to use Alic3dev if you do not agree to take
      ...
      <p>
        ...
        Alic3dev for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Alic3dev</li>
        <li>Sell, rent or sub-license material from Alic3dev</li>
        <li>Reproduce, duplicate or copy material from Alic3dev</li>
        <li>Redistribute content from Alic3dev</li>
      </ul>
      ...
      <p>
        ...
        Alic3dev does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Alic3dev,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Alic3dev shall not be liable
      ...
      <p>
        Alic3dev reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Alic3dev a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Alic3dev; and (d) the link is
      ...
      <p>
        No use of Alic3dev&apos;s logo or other artwork will be allowed for
